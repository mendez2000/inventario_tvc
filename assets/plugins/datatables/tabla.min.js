...
oPaginate:{sFirst:"<<",sLast:">>",sNext:">",sPrevious:"<"},sEmptyTable:"No hay información para mostrar",sInfo:"Mostrando _START_ - _END_ de un total de _TOTAL_ registros",sInfoEmpty:"Mostrando 0 - 0 de un total de 0 registros",sInfoFiltered:"(Filtradas de un total de _MAX_ total registros)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"Mostrar _MENU_ Registros",sLoadingRecords:"Cargando...",sProcessing:"Procesando...",sSearch:"Buscar:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"No hay registros relacionados con la busqueda"},oSearch:h.extend({},
