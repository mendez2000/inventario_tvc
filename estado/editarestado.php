                ...
                <form id="formest" role="form">
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control input-md" id="nombre_estado" name="nombre_estado" value="<?php if (isset($row["nombre_estado"])) echo $row["nombre_estado"]; ?>" style="text-transform:uppercase" placeholder="OPERANDO etc">
                        </div>

                    </div>

                    <div class="box-footer">
                        <button type="button" id="actualizar" name="actualizar" class="btn btn-success btn-flat">Actualizar</button>
