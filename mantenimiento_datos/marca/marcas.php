                ...
                <div class="box-header with-border">
                    ...
                    <form id="formmarca"   >
                        ...
                        <div id="demo" class="modal-body">
                            ...
                            <input type="text" class="form-control input-sm  help-block" id="nombre_marca" name="nombre_marca" required placeholder="Nombre de la Marca">
                        </div>
                        ...
                        <div class="modal-footer">
                            ...
                            <a  onclick="goBack()" class="btn btn-success btn-flat"  style="margin: 3px"><span class="fa fa-search"></span> Buscar Marcas</a>
                        </div>
                    </form>
                </div>
            </div>
