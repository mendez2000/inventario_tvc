...
<div class="container-fluid">
    <h2>MARCAS
        <a href="marcas.php" class="btn btn-flat btn-success btn-md">
             ...
             $proof=$mbd->query("select * from marca");
                ...
                while($row = $row = $proof->fetch(PDO::FETCH_ASSOC)){
                    ...
                    <tr>
                        ...
                        <td>
                            <a href=\"editarmarca.php?id=".$row["id_marca"]."\" class=\"btn btn-flat btn-info btn-sm\"><span class=\"glyphicon glyphicon-pencil\"></span></a>
                            <a id=\"eliminar\" name=\"eliminar\" value=\"".$row["id_marca"]."\" class=\"btn btn-flat btn_5 btn-sm btn-danger\"><span class=\"glyphicon glyphicon-trash\"></span></a>
                        </td> 
