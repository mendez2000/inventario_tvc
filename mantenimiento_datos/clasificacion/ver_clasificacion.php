        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 col-xs-12 table-responsive"> <!-- Note that "m8 l9" was added -->
                <table id="ver" class="display table" cellspacing="0" >
                    <thead>  
                        <tr>
                            ...
                            <th data-field="area">Clasificación</th>
                ...
                $mbd=DB::connect();DB::disconnect();
                    // VERDADERA
                $proof=$mbd->query("select * from clasificacion");
                    ...
                    while($row = $row = $proof->fetch(PDO::FETCH_ASSOC)){
                        ...
                        <tr>
                            ...
                            <td>
                                <a href=\"editarclasificacion.php?id=".$row["id_clasificacion_cpu"]."\" class=\"btn btn-flat btn-info btn-sm\">
                                        <span class=\"glyphicon glyphicon-pencil\"></span>
                                </a>
                                <a id=\"eliminar\" name=\"eliminar\" value=\"".$row["id_clasificacion_cpu"]."\" class=\"btn btn-flat btn_5 btn-sm btn-danger\"><span class=\"glyphicon glyphicon-trash\"></span>
                                </a>
                            </td> 
