    ...
    <div class="row">
        <div class="col-xs-12 col-md-12 col-lg-12 table-responsive"> 
            <table id="ver" class="display table " cellspacing="0" >
                ...
                $proof=$mbd->query("SELECT t_video.id_tarjeta_v,marca.nombre_marca,t_video.modelo,t_video.capacidad FROM t_video
                left JOIN marca ON t_video.id_marca=marca.id_marca
                ORDER BY t_video.id_tarjeta_v DESC;");
                $contador=0;
                while($row = $row = $proof->fetch(PDO::FETCH_ASSOC)){
                    ...
                    <tr>
                        ...
                        <td>".$row["capacidad"]."</td>  
                        <td>
                            <a href=\"editar.php?id=".$row["id_tarjeta_v"]."\" class=\"btn btn-flat btn-info btn-sm\"><span class=\"glyphicon glyphicon-pencil\"></span></a>
                            <a id=\"eliminar\" name=\"eliminar\" value=\"".$row["id_tarjeta_v"]."\" class=\"btn btn-flat btn_5 btn-sm btn-danger\"><span class=\"glyphicon glyphicon-trash\"></span></a>
                        </td> 
                    </tr>";
                }
                ?>
