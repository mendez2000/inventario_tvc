...
<body>
    <div class="container-fluid">
        <h2>TIPO DE RAM
            <a href="tipo_ram.php" class="btn btn-flat btn-success btn-md">
                ...
                <table id="ver" class="display table" cellspacing="0" >
                    <thead>
                        ...
                        <tr>
                            ...
                            <th data-field="Tipo Accesorio">Tipo Ram</th>
                    ...
                    <tbody>
                        <?php
                            ...
                            $proof=$mbd->query("SELECT * FROM tipo_ram");
                            $contador=0;
                            while($row = $row = $proof->fetch(PDO::FETCH_ASSOC)){
                                ...
                                <tr>
                                    ...
                                    <td>".$row["tipo_ram"]."</td>
                                    <td>
                                        <a href=\"editar_tipo.php?id=".$row["id_tipo_ram"]."\" class=\"btn btn-flat btn-info btn-sm\"><span class=\"glyphicon glyphicon-pencil\"></span></a>
                                        <a id=\"eliminar\" name=\"eliminar\" value=\"".$row["id_tipo_ram"]."\" class=\"btn btn-flat btn_5 btn-sm btn-danger\"><span class=\"glyphicon glyphicon-trash\"></span></a>
                                    </td> 
                                </tr>";
                            }
                        ?>
