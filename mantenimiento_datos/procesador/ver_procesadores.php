...
<div class="container-fluid">
    <h2>Procesadores
        <a href="procesador.php" class="btn btn-success btn-md">
        ...
        <div class="col-xs-12 col-md-12 col-lg-12 table-responsive"> <!-- Note that "m8 l9" was added -->
            <table id="ver" class="display table " cellspacing="0" >
                ...
                <tr>
                    ...
                    <th data-field="Marca">Fabricante</th>
                    <th data-field="tipo">Modelo</th>
                    <th data-field="Ver">Generación</th>
                    <th data-field="Editar">Velocidad</th>
                ...
                $proof=$mbd->query("SELECT * FROM procesador");
                $contador=0;
                while($row = $row = $proof->fetch(PDO::FETCH_ASSOC)){
                    ...
                    <tr>
                        ...
                        <td>
                            <a href=\"editarprocesador.php?id=".$row["id_procesador"]."\" class=\"btn btn-flat btn-info btn-sm\">
                            <span class=\"glyphicon glyphicon-pencil\"></span>
                            </a>
                            <a id=\"eliminar\" name=\"eliminar\" value=\"".$row["id_procesador"]."\" class=\"btn btn-flat btn_5 btn-sm btn-danger\"><span class=\"glyphicon glyphicon-trash\"></span>
                            </a>
                        </td> 
