...
<nav>
    ...
    <div class="container-fluid">
        <h2>Categorias
            <a href="categoria.php" class="btn btn-flat btn-success btn-md">
                ...
                <table id="ver" class="display table" cellspacing="0" >
                    <thead>
                        <tr>
                            ...
                            <th data-field="Tipo Accesorio">Categoría</th>
                    ...
                    <tbody>
                        <?php
                            ...
                            $proof=$mbd->query("SELECT * FROM categoria_software");
                            $contador=0;
                            while($row = $row = $proof->fetch(PDO::FETCH_ASSOC)){
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href=\"editar.php?id=".$row["id_categoria"]."\" class=\"btn btn-flat btn-info btn-sm\">
                                                <span class=\"glyphicon glyphicon-pencil\"></span>
                                        </a>
                                        <a id=\"eliminar\" name=\"eliminar\" value=\"".$row["id_categoria"]."\" class=\"btn btn-flat btn_5 btn-sm btn-danger\"><span class=\"glyphicon glyphicon-trash\"></span>
                                        </a>
                                    </td>        
                                </tr>";
                            }
