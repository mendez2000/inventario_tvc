                ...
                <form role="form">
                    <div class="box-body">
                            ...
                            <div class="col-12 col-lg-6 col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" id="inventario" name="inventario" class="form-control input-sm" placeholder="Numero de Inventario">
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-lg-6 col-md-6">
                                <div class="form-group">
                                    <label for="serie"> Capacidad </label>
            ...
            $.ajax({
                ...
                success: function(data)
                {
                    ...
                    $.each(data, function(i, item) {
                        ...
                        {
                            toastr.error('Error','Inventario existente!');
