...
$mbd=DB::connect();DB::disconnect();
       $proof=$mbd->query("SELECT ups.id_ups,ups.num_inventario,ups.id_marca,marca.nombre_marca,ups.modelo,ups.capacidad,ups.fecha_compra,ups.observacion FROM ups
       LEFT JOIN marca ON marca.id_marca=ups.id_marca WHERE ups.id_ups= '$id';");
...
<div id="cuerpo" class="col-md-12" > 
    <section class="content-header">
        <h1>
            Ups
            <small>Editar Ups</small>
        </h1>
        <ol class="breadcrumb">
            <li><a ><i class="fa fa-dashboard"></i> Home</a></li>
            <li><a >Ups</a></li>
            <li class="active">Editar Ups</li>
        </ol>
    </section>
        <div class="box box-primary">
            <div class="box-header with-border">
                <h2 class="box-title">Editar Ups</h2>
            </div>
                    ...
                    <div class="box-body">
                        ...
                        <div class="row ">
                            <div class="col-12 col-lg-6 col-md-6">
                                ...
                                <input type="text" class="form-control  input-sm  help-block" id="modelo" value="<?php echo $modelo; ?>" name="modelo" placeholder="Serie del monitor">
                            </div>
                            </div>

                            <div class="col-12 col-lg-6 col-md-6">
                                <div class="form-group">
                                <label for="serv"> Capacidad </label>
                                <input type="text" class="form-control  input-sm  help-block" id="capacidad" value="<?php echo $capacidad; ?>" name="capacidad" placeholder="Capacidad">
                            </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-lg-6 col-md-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control input-sm" id="fecha_compra" name="fecha_compra" value="<?php echo $fecha; ?>">
                                </div>
                            </div>
        ...
        <script>
                    ...
                    function goBack(){
                        setTimeout(function(){  window.location.href="ver_ups.php";  }, 30);
                    }
